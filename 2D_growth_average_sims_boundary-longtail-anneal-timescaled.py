...
anneal_tau=167099.96807418027
anneal_alpha=0.958799109191608
# anneal_tau=1.5e5
# anneal_alpha=0.85
...
###this is paper standard

# foldername='cell auto results/log-time-early-test/include-growth/scaled-t/starting-config-comp/{}nucs_{}size_{}growth-scaled-time-{:.2E}rate-markov-poisson_{}anneal_hard/alpha{:.2f}_tau{:.2E}-longtail-anneal_bound{:.1E}-{:.1E}-ave{}'.format(nCen,nSize,nSteps_growth,rate,nSteps_anneal,anneal_alpha,anneal_tau,boundary_thres_start,boundary_thres_final,num_iters)

###
# foldername='cell auto results\\log-time-early-test\\include-growth\\scaled-t\\starting-config-comp\\paper_standard'  
foldername=f'cell auto results\\paper_standard\\alpha{anneal_alpha:.2f}_tau{anneal_tau:.2E}'
...
starting_dict=np.load('starting_nuc_pos_rad_test.npz')
...
np.savez(os.path.join(foldername,f'longtail_multi_average_arrays_w-area{num_prev_runs}_iter{num_iters}.npz'),corr_funcs=corr_funcs,intensity_funcs=intensity_funcs,ROI_mins=ROI_mins,ROI_maxs=ROI_maxs,new_phase_area=new_phase_area,timeSteps=timeSteps,percents_anneal=percents_anneal)